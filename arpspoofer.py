...
def get_mac_address(ip_address):
    ...
    arp_layer = scapy.ARP(dst=ip_address)
    get_mac_packet = broadcast_layer / arp_layer
    aswer = scapy.srp(get_mac_packet, timeout=2, varbose=False)[0]
    return aswer[0][1].hwsrc
...
terget_mac = str(get_mac_address(target_ip))
